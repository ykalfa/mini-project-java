...
public class TriangleTest {
    ...
    public void Test17()
    {
        ...
        System.out.println(normal);
        assertEquals("Bad normal!","(0.71, 0.71, 0.00)" ,normal.toString());
    }
    /************************************ Plane test *****************************************************/
    @Test
    public void Test18() {
        ...
        public void emmissionTest()
        {
           ...
           Triangle triangle = new Triangle(new Point3D( 100, 0, -50),
            ...
            sphere.setEmmission(new Color (255, 254, 253));
            triangle.setEmmission(new Color (19, 23, 255));
            triangle2.setEmmission(new Color (255, 245, 41));
            triangle3.setEmmission(new Color (255, 255, 27));
            triangle4.setEmmission(new Color (34, 43, 255));
